...
class CartItemsControllerTest < ActionController::TestCase
  ...
  test "should create cart_item" do
    assert_difference('CartItem.count') do
      post :create, cart_item: { customer_id: @cart_item.customer_id, product_id: @cart_item.product_id, quantity_ordered: @cart_item.quantity_ordered }
    end
  ...
  test "should update cart_item" do
    patch :update, id: @cart_item, cart_item: { customer_id: @cart_item.customer_id, product_id: @cart_item.product_id, quantity_ordered: @cart_item.quantity_ordered }
    assert_redirected_to cart_item_path(assigns(:cart_item))
  end
